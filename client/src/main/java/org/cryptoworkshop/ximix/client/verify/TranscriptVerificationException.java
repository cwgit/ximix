 ...
 */
public class TranscriptVerificationException
    extends Exception
{
    /**
     ...
     */
    public TranscriptVerificationException(String msg)
    {
        super(msg);
    }
     ...
     */
    public TranscriptVerificationException(String msg, Throwable cause)
    {
        super(msg, cause);
    }
}
